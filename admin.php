...
$stmt = $pdo->prepare('SELECT users.n_cliente, users.nome, fichas.n_ficha, fichas.estado, fichas.nota, fichas.created_at, fichas.problema FROM users INNER JOIN fichas ON users.n_cliente = fichas.n_cliente ORDER BY n_ficha');
$stmt->execute();
